                ...
                <div className="space-y-6">
                    <section className="space-y-3">
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            ...
                            It provides a clean, responsive interface for browsing movie information
                            from the YTS API.
                        </p>
                    </section>
                    ...
                    <section className="space-y-3">
                        ...
                        <div className="bg-muted/50 border border-border rounded-lg p-6 space-y-3">
                            ...
                            <p className="text-muted-foreground leading-relaxed">
                                ...
                                from the YTS public API. This project was created solely for
                                educational and portfolio purposes to showcase technical skills in
                                front-end development.
                            </p>
                            <p className="text-muted-foreground leading-relaxed">
                                The developer does not condone or encourage piracy. Please respect
                    ...
                    <section className="space-y-3">
                        ...
                        <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                            ...
                            <li>
                                <strong>TypeScript 5.9</strong> for type safety
                            </li>
                            <li>
                                <strong>Vite 7</strong> for fast builds and development
                            </li>
                            <li>
                                <strong>Tailwind CSS 4</strong> for styling
                            </li>
                            <li>
                                <strong>Radix UI</strong> for accessible component primitives
                            </li>
                            <li>
