...
export const FeaturedMovieCarousel = ({ movies = [], className, ...props }: FeaturedMovieCarouselProps) => {
    ...
    return (
        <>
            <Carousel {...props} plugins={[ Autoplay({ delay: 4000, jump: true, stopOnInteraction: false, stopOnFocusIn: false, }) ]} setApi={setApi} className={cn("", className)}>
                <CarouselContent>
                {   movies.map((movie, i) =>
