...
const LIST_GROUPS: ListGroup[] = [
    ...
    },
    {
        ...
        options: [
            {
                label: 'Top Action',
                params: { genre: 'action', sort_by: 'rating', minimum_rating: 7 },
            },
    ...
    },
    {
        ...
        options: [
            ...
            {
                label: 'Critically Acclaimed (8+)',
                params: { minimum_rating: 8, sort_by: 'rating' },
            },
            { label: 'Latest Releases', params: { sort_by: 'year', order_by: 'desc' } },
            { label: 'Alphabetical', params: { sort_by: 'title', order_by: 'asc' } },
            {
                label: 'Hidden Gems',
                params: { minimum_rating: 7, sort_by: 'peers', order_by: 'asc' },
            },
        ],
    },
];
            ...
            <DropdownMenuContent align="start" className="sm:grid sm:grid-cols-3 sm:p-2 sm-pb-4 ">
                {LIST_GROUPS.map((group, groupIndex) => (
                    <div key={group.label}>
                        ...
                        {groupIndex < LIST_GROUPS.length - 1 && (
